<?php
    ...
    $zone_id= mysqli_real_escape_string($con,stripslashes($r-> zone_id));
 ...
 $geometry = $r -> geometry;
    ...
    $res = modifyZone($_SESSION["account_id"],$zone_id,$description,$zone_name,$area_address,$message,json_encode($geometry),$zone_type,$group_name,$included_users);
    $arr = [];
    if($res){
